...
public final class JustFriendPlugin extends JavaPlugin implements JustFriendAPI {
    ...
    @Override public void onEnable(){
        instance=this;saveDefaultConfig();for(String file:List.of("messages.yml","gui.yml","matchmaking.yml","storage.yml"))if(!new File(getDataFolder(),file).exists())saveResource(file,false);loadExtraConfigs();
