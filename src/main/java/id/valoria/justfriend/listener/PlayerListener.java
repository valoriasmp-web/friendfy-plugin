...
public final class PlayerListener implements Listener {
    ...
    @EventHandler public void onQuit(PlayerQuitEvent e){plugin.getMatchmaking().leave(e.getPlayer(),false);plugin.getSessions().onQuit(e.getPlayer());plugin.getNeverAlone().quit(e.getPlayer());}
